 ...
 * pagina user alla view definita da noi, gestirne le richieste POST, e redirezionare tutte le altre pagine verso 404.
 */
class PaginaUser
{
    /*
    ...
    public static function mostraPaginaUser()
    {
        ...
        // mostra la pagina
        include SNIPPETS_BASE_PATH . "views/user.php";
    }
